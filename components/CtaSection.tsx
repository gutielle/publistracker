  ...
  return (
    <section id="cta" className="bg-white py-20 sm:py-24">
      <div className="container mx-auto px-6">
        <div className="bg-primary-600 rounded-2xl shadow-xl text-white p-10 md:p-16 text-center transform hover:scale-[1.02] transition-transform duration-500">
          ...
          <div className="mt-8">
            <a
              href="/success"
              className="bg-white text-primary-600 font-bold px-8 py-4 rounded-lg shadow-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-75 transition-all transform hover:scale-105 duration-300"
            >
